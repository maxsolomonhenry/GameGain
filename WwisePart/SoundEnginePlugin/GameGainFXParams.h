...
#ifndef GameGainFXParams_H
#define GameGainFXParams_H
...
struct GameGainRTPCParams
{
    AkReal32 fPlaceholder;
};

struct GameGainNonRTPCParams
{
};

struct GameGainFXParams
    : public AK::IAkPluginParam
{
    GameGainFXParams();
    GameGainFXParams(const GameGainFXParams& in_rParams);
    ...
    GameGainRTPCParams RTPC;
    GameGainNonRTPCParams NonRTPC;
};

#endif // GameGainFXParams_H
